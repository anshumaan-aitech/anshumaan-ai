...
const socialLinks = [
  ...
  },
  {
    ...
    color:
      "text-neutral-900 dark:text-white hover:text-neutral-700 dark:hover:text-neutral-300",
  },
];
                ...
                {socialLinks.map((social, index) => (
                  ...
                  >
                    <div className="w-14 h-14 bg-neutral-100 dark:bg-neutral-800 rounded-xl flex items-center justify-center group-hover:bg-brand-100 dark:group-hover:bg-brand-900 transition-all duration-300 shadow-lg">
                      <social.icon
                        className={`w-7 h-7 ${social.color} group-hover:text-brand-600 dark:group-hover:text-brand-400 transition-colors`}
                      />
                    </div>

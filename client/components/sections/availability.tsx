...
const workModes = [
  {
    ...
    title: "Remote Work",
    description:
      "Fully equipped for remote collaboration with modern tools and technologies",
    available: true,
  },
  {
    icon: Briefcase,
  ...
  },
  {
    ...
    title: "24/7 Support",
    description:
      "Dedicated support for critical project phases and deployments",
    available: true,
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-neutral-600 dark:text-neutral-400 max-w-3xl mx-auto">
            Ready to collaborate on your next project. Here's my current
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {availabilityItems.map((item, index) => (
            ...
            >
              <div
                className={`w-16 h-16 ${item.bgColor} rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg`}
              >
